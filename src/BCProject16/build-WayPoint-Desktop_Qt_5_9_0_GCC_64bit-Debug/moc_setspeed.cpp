...
QT_MOC_LITERAL(3, 19, 3), // "min"
QT_MOC_LITERAL(4, 23, 3), // "max"
QT_MOC_LITERAL(5, 27, 21) // "on_pushButton_clicked"

    },
    "setspeed\0getspeed\0\0min\0max\0"
...
void setspeed::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getspeed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (setspeed::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&setspeed::getspeed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void setspeed::getspeed(int _t1, int _t2)
{
