...
//    label_camera1=new QLabel(this);
    label_camera1=new CFramePlayWnd(this);
...
//    label_camera1->setPixmap(QPixmap(":/picture/black.jpg"));
    ...
    label_camera1->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(133, 133, 133);");


//    label_camera2=new QLabel(this);
    label_camera2=new CFramePlayWnd(this);
...
//    label_camera2->setPixmap(QPixmap(":/picture/black.jpg"));
    label_camera2->setFrameShape(QFrame::StyledPanel);
    label_camera2->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(133, 133, 133);");


//    label_camera3=new QLabel(this);
    label_camera3=new CFramePlayWnd(this);
...
//    label_camera3->setPixmap(QPixmap(":/picture/black.jpg"));
    label_camera3->setFrameShape(QFrame::StyledPanel);
    label_camera3->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(133, 133, 133);");


//    label_camera4=new QLabel(this);
    label_camera4=new CFramePlayWnd(this);
...
//    label_camera4->setPixmap(QPixmap(":/picture/black.jpg"));
    label_camera4->setFrameShape(QFrame::StyledPanel);
    label_camera4->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(133, 133, 133);");
    ...
    connect(label_camera1,SIGNAL(DoubleClickSig()),this,SLOT(DoubleClick_slot1()));
    connect(label_camera2,SIGNAL(DoubleClickSig()),this,SLOT(DoubleClick_slot2()));
    connect(label_camera3,SIGNAL(DoubleClickSig()),this,SLOT(DoubleClick_slot3()));
    connect(label_camera4,SIGNAL(DoubleClickSig()),this,SLOT(DoubleClick_slot4()));
    ...
    if(!isValidIP(m_cameraIP1))
    {
        ...
        label_camera1->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(230, 5, 5);");
    }
    ...
    if(!isValidIP(m_cameraIP2))
    {
        ...
        label_camera2->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(230, 5, 5);");
    }
    ...
    if(!isValidIP(m_cameraIP3))
    {
        ...
        label_camera3->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(230, 5, 5);");
    }
    ...
    if(!isValidIP(m_cameraIP4))
    {
        ...
        label_camera4->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(230, 5, 5);");
    }
...
//    m_recvimagethread1->start();//在ros中，对于多线程的回调函数，只需要一个ros::spin()或ros::spinonce()
    ...
    m_conhccamerathread1=new ConHCCameraThread(m_cameraIP1.toStdString().c_str(),username,password,"VideoImage1",1,13,15,(HWND)label_camera1->GetPlayWndId());
    m_conhccamerathread2=new ConHCCameraThread2(m_cameraIP2.toStdString().c_str(),username,password,"VideoImage2",1,12,11,(HWND)label_camera2->GetPlayWndId());
    m_conhccamerathread3=new ConHCCameraThread3(m_cameraIP3.toStdString().c_str(),username,password,"VideoImage3",1,12,11,(HWND)label_camera3->GetPlayWndId());
    m_conhccamerathread4=new ConHCCameraThread4(m_cameraIP4.toStdString().c_str(),username,password,"VideoImage4",1,13,15,(HWND)label_camera4->GetPlayWndId());
...
//双击最大化、还原
void ImageWidget::DoubleClick_slot1()
{
    if(fullscreen_ID<=0)
    {
        label_camera1->setGeometry(0,0,this->width(),this->height());
        label_camera1->raise();

        fullscreen_ID=1;
        m_conhccamerathread1->resetHKandconnectHK(0); //主码流
    }
    else if(fullscreen_ID==1)
    {
        m_conhccamerathread1->resetHKandconnectHK(1); //子码流
...
void ImageWidget::DoubleClick_slot2()
{
    if(fullscreen_ID<=0)
    {
        label_camera2->setGeometry(0,0,this->width(),this->height());
        label_camera2->raise();
...
void ImageWidget::DoubleClick_slot3()
{
    if(fullscreen_ID<=0)
    {
        label_camera3->setGeometry(0,0,this->width(),this->height());
        label_camera3->raise();
...
void ImageWidget::DoubleClick_slot4()
{
    if(fullscreen_ID<=0)
    {
        label_camera4->setGeometry(0,0,this->width(),this->height());
        label_camera4->raise();
...
void ImageWidget::thread1_save_slot(int _save)
{
    if(_save>0)
    {
        label_camera1->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(0, 220, 13);");
...
void ImageWidget::thread2_save_slot(int _save)
{
    if(_save>0)
    {
        label_camera2->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(0, 220, 13);");
...
void ImageWidget::thread3_save_slot(int _save)
{
    if(_save>0)
    {
        label_camera3->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(0, 220, 13);");
...
void ImageWidget::thread4_save_slot(int _save)
{
    if(_save>0)
    {
        label_camera4->setStyleSheet("border-width: 2px;border-style: solid;border-color: rgb(0, 220, 13);");
