...
const QMetaObject Wheel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Wheel.data,
      qt_meta_data_Wheel,  qt_static_metacall, nullptr, nullptr}
};
...
void *Wheel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Wheel.stringdata0))
        return static_cast<void*>(const_cast< Wheel*>(this));
