#ifndef CONHCCAMERATHREAD3_H
#define CONHCCAMERATHREAD3_H
...
class ConHCCameraThread3 : public QThread
{
    Q_OBJECT
...
public:
    ...
    ConHCCameraThread3(const char* deviceIp, const char* userName, const char* passWord, const char* topicName,
...
public:
   static ConHCCameraThread3 *m_conHC3;

};

#endif // CONHCCAMERATHREAD3_H
