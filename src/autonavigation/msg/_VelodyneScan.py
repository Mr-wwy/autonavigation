...
"""autogenerated by genpy from autonavigation/VelodyneScan.msg. Do not edit."""
import sys
...
class VelodyneScan(genpy.Message):
  _md5sum = "b84db49b197bce2da993f944c9202cd1"
  _type = "autonavigation/VelodyneScan"
...
"""
  __slots__ = ['header','localPose','gpsPos','packets']
  _slot_types = ['std_msgs/Header','autonavigation/LocalPose','autonavigation/GpsPosition','autonavigation/VelodynePacket[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,localPose,gpsPos,packets
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autonavigation.msg.VelodynePacket()
        _v2 = val1.stamp
        _x = _v2
        start = end
        end += 8
