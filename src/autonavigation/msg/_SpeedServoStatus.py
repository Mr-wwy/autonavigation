...
"""autogenerated by genpy from autonavigation/SpeedServoStatus.msg. Do not edit."""
import sys
...
class SpeedServoStatus(genpy.Message):
  _md5sum = "91bbb94b1c08c13aa4b81b868ef0ac37"
  _type = "autonavigation/SpeedServoStatus"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeedServoStatus, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_8d7i.pack(_x.DesiredSpeed, _x.DesiredAcc, _x.CurrentSpeed, _x.CurrentAcc, _x.DesiredBrake, _x.CurrentBrake, _x.DesiredFuel, _x.CurrentFuel, _x.DesiredTransPos, _x.CurrentTransPos, _x.HardSwitchOn, _x.EmergenceFlag, _x.BcanControlFlag, _x.HornOnFlag, _x.EmergencyLightonFlag))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.DesiredSpeed, _x.DesiredAcc, _x.CurrentSpeed, _x.CurrentAcc, _x.DesiredBrake, _x.CurrentBrake, _x.DesiredFuel, _x.CurrentFuel, _x.DesiredTransPos, _x.CurrentTransPos, _x.HardSwitchOn, _x.EmergenceFlag, _x.BcanControlFlag, _x.HornOnFlag, _x.EmergencyLightonFlag,) = _struct_8d7i.unpack(str[start:end])
      return self
