...
;//! \htmlinclude TrafficMark.msg.html

(cl:defclass <TrafficMark> (roslisp-msg-protocol:ros-message)
  ((head
    :reader head
    :initarg :head
...
(cl:defclass TrafficMark (<TrafficMark>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TrafficMark>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TrafficMark)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonavigation-msg:<TrafficMark> is deprecated: use autonavigation-msg:TrafficMark instead.")))

(cl:ensure-generic-function 'head-val :lambda-list '(m))
(cl:defmethod head-val ((m <TrafficMark>))
...
(cl:defmethod localPose-val ((m <TrafficMark>))
...
(cl:defmethod gpsPos-val ((m <TrafficMark>))
...
(cl:ensure-generic-function 'markingNum-val :lambda-list '(m))
(cl:defmethod markingNum-val ((m <TrafficMark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonavigation-msg:markingNum-val is deprecated.  Use autonavigation-msg:markingNum instead.")
  (markingNum m))

(cl:ensure-generic-function 'markings-val :lambda-list '(m))
(cl:defmethod markings-val ((m <TrafficMark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonavigation-msg:markings-val is deprecated.  Use autonavigation-msg:markings instead.")
  (markings m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrafficMark>) ostream)
  "Serializes a message object of type '<TrafficMark>"
  ...
  (cl:let* ((signed (cl:slot-value msg 'markingNum)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficMark>) istream)
  "Deserializes a message object of type '<TrafficMark>"
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'gpsPos) istream)
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'markingNum) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TrafficMark>))
  "Converts a ROS message object to a list"
  (cl:list 'TrafficMark
    (cl:cons ':head (head msg))
    (cl:cons ':localPose (localPose msg))
    (cl:cons ':gpsPos (gpsPos msg))
    (cl:cons ':markingNum (markingNum msg))
