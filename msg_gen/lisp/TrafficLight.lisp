...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonavigation-msg:<TrafficLight> is deprecated: use autonavigation-msg:TrafficLight instead.")))

(cl:ensure-generic-function 'head-val :lambda-list '(m))
(cl:defmethod head-val ((m <TrafficLight>))
...
(cl:defmethod localPose-val ((m <TrafficLight>))
...
(cl:defmethod gpsPos-val ((m <TrafficLight>))
...
(cl:defmethod lightNum-val ((m <TrafficLight>))
...
(cl:defmethod lights-val ((m <TrafficLight>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrafficLight>)))
  ...
  "4afac40d7d61ec7e5dc4f4078daf1155")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrafficLight)))
  "Returns md5sum for a message object of type 'TrafficLight"
  "4afac40d7d61ec7e5dc4f4078daf1155")
