...
(cl:defmethod cl:initialize-instance :after ((m <VehicleInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonavigation-msg:<VehicleInfo> is deprecated: use autonavigation-msg:VehicleInfo instead.")))

(cl:ensure-generic-function 'head-val :lambda-list '(m))
(cl:defmethod head-val ((m <VehicleInfo>))
...
(cl:defmethod localPose-val ((m <VehicleInfo>))
...
(cl:defmethod gpsPos-val ((m <VehicleInfo>))
...
(cl:defmethod vehicleNum-val ((m <VehicleInfo>))
...
(cl:defmethod vehicles-val ((m <VehicleInfo>))
