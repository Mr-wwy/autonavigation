...
private slots:
    ...
    void T0_data(const autonavigation::SetT0::ConstPtr &sett0);
    void GpsTime_data(const autonavigation::GpsTime::ConstPtr &gpstime);

    void modifyfilename_slot(QString newfilename);
    ...
    void settime_surebtn_clicked_slot(int _time);
...
private:
    ...
    RecvGpsTimeThread m_recvgpstimethread;
    RecvT0Thread m_recvt0thread;
...
//    QLabel *m_LA_millisecond;
    ...
    int m_setdelaytime_t0;
    quint32 m_save_distance;
