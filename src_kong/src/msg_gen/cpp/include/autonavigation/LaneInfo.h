/* Auto-generated by genmsg_cpp for file /home/wangyi/rosros_autonavigation_ws/src/autonavigation/msg/LaneInfo.msg */
#ifndef AUTONAVIGATION_MESSAGE_LANEINFO_H
#define AUTONAVIGATION_MESSAGE_LANEINFO_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct LaneInfo_ {
  ...
  typedef boost::shared_ptr< ::autonavigation::LaneInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autonavigation::LaneInfo_<ContainerAllocator>  const> ConstPtr;
}; // struct LaneInfo
typedef  ::autonavigation::LaneInfo_<std::allocator<void> > LaneInfo;

typedef boost::shared_ptr< ::autonavigation::LaneInfo> LaneInfoPtr;
typedef boost::shared_ptr< ::autonavigation::LaneInfo const> LaneInfoConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::autonavigation::LaneInfo_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::autonavigation::LaneInfo_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::autonavigation::LaneInfo_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::autonavigation::LaneInfo_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::autonavigation::LaneInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "7c49bac42dba320a14daf5f0b3af276c";
  }

  static const char* value(const  ::autonavigation::LaneInfo_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x7c49bac42dba320aULL;
  static const uint64_t static_value2 = 0x14daf5f0b3af276cULL;
};

template<class ContainerAllocator>
struct DataType< ::autonavigation::LaneInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "autonavigation/LaneInfo";
  }
...
template<class ContainerAllocator>
struct Definition< ::autonavigation::LaneInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "Header      head\n\
LocalPose   localPose\n\
...
template<class ContainerAllocator> struct Serializer< ::autonavigation::LaneInfo_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::autonavigation::LaneInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::autonavigation::LaneInfo_<ContainerAllocator> & v) 
  {
    s << indent << "head: ";
s << std::endl;
...
#endif // AUTONAVIGATION_MESSAGE_LANEINFO_H
