...
#define ACC_UDP_PORT_WAYPOINT 4502
...
#define RECV_WAYPOINTS_NUM 50    //接受路点个数为50
...
struct Autonavigation_RecvWayPoints
{
    boost::int32_t       waypointnumA;               //路点个数
    boost::int32_t       Apx[RECV_WAYPOINTS_NUM];    //路点X坐标,单位cm
    boost::int32_t       Apy[RECV_WAYPOINTS_NUM];    //路点Y坐标，单位cm
    boost::int32_t       waypointnumB;               //路点个数
    boost::int32_t       Bpx[RECV_WAYPOINTS_NUM];    //路点X坐标,单位cm
    boost::int32_t       Bpy[RECV_WAYPOINTS_NUM];    //路点Y坐标，单位cm
};
