    ...
    ui(new Ui::ImageWidget)
{
    ...
    label_camera1->setFrameShape(QLabel::Box);
    ...
    m_conhccamerathread2=new ConHCCameraThread2(m_cameraIP2.toStdString().c_str(),username,password,"VideoImage2",1,12,11);
    m_conhccamerathread3=new ConHCCameraThread3(m_cameraIP3.toStdString().c_str(),username,password,"VideoImage3",1,12,11);
    m_conhccamerathread4=new ConHCCameraThread4(m_cameraIP4.toStdString().c_str(),username,password,"VideoImage4",1,13,11);
